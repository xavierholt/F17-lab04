package edu.ucsb.cs56.drawings.dianareyes.simple;
...
/**
   ...
   @author Diana Reyes (fixed the snowmans's head)
...
{  
	...
	Circle snowManTopCircle = 
		...
		(
		 snowManCenterBottomX,
		 snowManCenterBottomY - topRadius *7 - topRadius,
		 topRadius
		 );
	...
	g2.drawString("Snowman Head added by Diana Reyes", 20, 20);

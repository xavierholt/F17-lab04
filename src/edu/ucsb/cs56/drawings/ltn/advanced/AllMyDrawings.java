...
public class AllMyDrawings
{
	...
	g2.drawString("A bunch of water bottles with straws", 20, 20);

	//Draw some water bottles  with straws

	WaterBottleWithStraw w1 = new WaterBottleWithStraw(100, 100, 50, 150);
	WaterBottleWithStraw w2 = new WaterBottleWithStraw(200, 200, 50, 100);
	g2.setColor(Color.BLUE); g2.draw(w1);

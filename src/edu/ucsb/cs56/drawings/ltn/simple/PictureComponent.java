package edu.ucsb.cs56.drawings.ltn.simple;
...
/**
   ...
   @author @@@ Lindsey Nguyen (fixed the snowmans's head)
...
{  
    ...
    {  
        ...
        Circle snowManBottomCircle = 
	     ...
	     bottomRadius - snowManCenterBottomY,
	     bottomRadius
	     );
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Added snowManTopCircle, Lindsey Nguyen", 20,20);

package edu.ucsb.cs56.drawings.mberlanga.simple;
...
/**
   ...
   @author @@@ Miguel Berlanga (fixed the snowmans's head)
...
{  
	...
	Circle snowManSmallCircle =
	    new Circle(snowManCenterBottomX, snowManCenterBottomY- 2*bottomRadius - 2*middleRadius - topRadius,topRadius);
        g2.draw(snowManSmallCircle);


        // @@@ FINALLY, SIGN AND LABEL YOUR DRAWING
	// @@@ 20, 20 are suggested coordinates, but you may change them

        g2.drawString("Snow Man w/ House, Miguel Berlanga", 20,20);

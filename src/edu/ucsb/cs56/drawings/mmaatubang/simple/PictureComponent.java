package edu.ucsb.cs56.drawings.mmaatubang.simple;
...
/**
   ...
   @author Matt Maatubang (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
       ...
       g2.drawString("Dope ass snowman made by Matt Maatubang", 20,20);
